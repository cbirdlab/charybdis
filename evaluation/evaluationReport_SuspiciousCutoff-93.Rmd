...
# Load data 
sapTbl <- read.csv(file = "classification_SuspiciousCutoff-93.csv", header = TRUE)
fastaLen = 5636
...
**Note:**  In this document, the cutoff for finding “suspicious” database records is an identity score of 0.93. This is because it comes between 0.90 and 0.97, which have already been considered. 
...
![](resultsClassificationTree_SuspiciousCutoff-93.png)
...
- Correctly Classified Instances: 213 (80.9886%)
- Incorrectly Classified Instances: 50 (19.0114%)
- Kappa statistic: 0.6212
- Mean absolute error: 0.2857
- Root mean squared error: 0.3826
- Relative absolute error: 68.2814%
- Root relative squared error: 77.295%
...
| ------- | ------- | --------- | ------ | --------- | -------- | ----- |
| 0.870 | 0.240 | 0.733 | 0.876 | 0.798 | 0.833 | True |
| 0.760 | 0.124 | 0.823 | 0.810 | 0.811 | 0.833 | False |
...
- Where the "suspicious homologues" node of the decision tree dissappeared with a cutoff of 0.97, it returned for 0.93. The accuracy is closer to that of the tree when the identity cutoff is 0.90. 
